...
export const FIELD_HELP: Record<string, string> = {
  ...
  password_complexity: "Character types a password must include—uppercase, lowercase, number, special.",
  complexity_requirements: "Character types a password must include—uppercase, lowercase, number, special.",
  ...
  // Incident Response
  incident_contact_email: "Email address for reporting security incidents (e.g., security@company.com).",
  ...
  // Mobile Device
  device_encryption_required: "Whether all mobile devices accessing company data must be encrypted.",
  ...
  personal_use_time_limit: "Enter minutes (e.g., 30) staff may use IT resources for personal tasks each day.",
