  ...
  const fetchSystemData = async () => {
    ...
    try {
      ...
      if (!securityError && securityData) {
        const settings = {
          twoFactor: securityData.find(
            (s) => s.setting_name === "two_factor_required",
          )?.setting_value
            ? (
                securityData.find(
                  (s) => s.setting_name === "two_factor_required",
            ...
            : false,
          rateLimiting: securityData.find(
            (s) => s.setting_name === "rate_limiting_enabled",
          )?.setting_value
            ? (
                securityData.find(
                  (s) => s.setting_name === "rate_limiting_enabled",
            ...
            : true,
          auditLogging: securityData.find(
            (s) => s.setting_name === "audit_logging_enabled",
          )?.setting_value
            ? (
                securityData.find(
                  (s) => s.setting_name === "audit_logging_enabled",
            ...
            : true,
          sessionTimeout: securityData.find(
            (s) => s.setting_name === "session_timeout_enabled",
          )?.setting_value
            ? (
                securityData.find(
                  (s) => s.setting_name === "session_timeout_enabled",
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Monitor and configure system settings, security, and
                      infrastructure
                    </p>
                  </div>
                  <Button
                      ...
                      <>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                          ...
                          <Card>
                            ...
                            <CardContent>
                              <div className="text-2xl font-bold">
                                {healthData?.storage || 0}%
                              </div>
                              <Progress
                                value={healthData?.storage || 0}
                                className="mt-2"
                              />
                              <p className="text-xs text-muted-foreground mt-1">
                                Storage used
                            ...
                            <CardContent className="space-y-4">
                              ...
                              <div className="pt-4 border-t">
                                <Button
                                  ...
                                  className="w-full"
                                  onClick={() =>
                                    window.open("/security-test", "_blank")
                                  }
                                >
                                  View Security Logs
                                </Button>
                            ...
                            <CardContent className="space-y-4">
                              ...
                              <div className="pt-4 border-t space-y-2">
                                ...
                                <div className="text-sm text-muted-foreground">
                                  <p>
                                    Next scheduled:{" "}
                                    {healthData?.backup?.nextScheduled ||
                                      "Sunday 2:00 AM UTC"}
                                  </p>
