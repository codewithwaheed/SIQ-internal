        ...
        <div className="max-w-4xl mx-auto px-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center p-4 bg-muted/50 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">Basic security controls for low-risk systems</p>
                </div>
                <div className="text-center p-4 bg-muted/50 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">Enhanced controls for moderate-risk systems</p>
                </div>
                <div className="text-center p-4 bg-muted/50 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">Rigorous controls for high-risk systems</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-4">
                  <h4 className="font-semibold mb-2">Joint Authorization Board (JAB) P-ATO</h4>
                  <p className="text-sm text-muted-foreground mb-2">
                    Provisional Authorization to Operate granted by the JAB for cloud services with widespread government use.
                  </p>
          ...
          <Card>
            <CardContent className="p-8 text-center">
              <h3 className="text-2xl font-bold mb-4">Need FedRAMP Authorization Guidance?</h3>
              <p className="text-muted-foreground mb-6">
                Navigate the complex FedRAMP authorization process with expert AI assistance and consulting services.
              </p>
