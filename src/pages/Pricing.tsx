        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            {plans.map((plan, index) => (
              <Card
                key={index}
                className={`relative hover-scale transition-all duration-300 animate-fade-in ${plan.popular ? "ring-2 ring-primary" : ""}`}
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  Express, Discover), debit cards, digital wallets (Apple Pay,
                  Google Pay), bank transfers, SEPA Direct Debit, and can
                  provide invoicing for enterprise customers. All payments are
