        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Join our trusted network of cybersecurity professionals supporting
              SMBs with meaningful, flexible work.
            </p>
          </div>
            ...
            >
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    <Label className="text-base font-medium">
                      Primary Areas of Expertise (check all that apply) *
                    </Label>
                    <div className="mt-2 grid grid-cols-2 gap-2">
                      {[
                        ...
                        "NIST 800-53",
                        "CMMC (Level 1)",
                        "CMMC (Level 2 or Provisional Assessor)",
                        "SOC 2",
                        "FedRAMP",
                        "HIPAA",
                        "ISO 27001",
                  ...
                  <div>
                    ...
                    <div className="mt-2 grid grid-cols-2 gap-2">
                      {["CISSP", "CISM", "CCSP", "CISA", "PMP", "CEH"].map(
                        (cert) => (
                          <div
                            key={cert}
                            className="flex items-center space-x-2"
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                placeholder="List other relevant certifications"
                                {...field}
                              />
                            </FormControl>
                            <FormMessage />
                  ...
                  <div>
                    <Label className="text-base font-medium">
                      Have you worked with SMBs under 300 employees? *
                    </Label>
                    <div className="mt-2 space-y-2">
                  ...
                  <div>
                    <Label className="text-base font-medium">
                      Have you served as a vCISO or cybersecurity advisor? *
                    </Label>
                    <div className="mt-2 space-y-2">
                      <div className="flex items-center space-x-2">
                        <input
                ...
                <CardContent className="space-y-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          Timezone / Preferred Working Hours *
                        </FormLabel>
                        <FormControl>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <Label htmlFor="resume" className="text-base font-medium">
                      Upload Resume or CV (PDF or DOCX)
                    </Label>
                    <Input
                      id="resume"
                      type="file"
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            placeholder="Provide contact information for references or paste testimonials"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Final requirements to complete your application
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div>
                    <Label className="text-base font-medium">
                      Do you agree to a background check if requested? *
                    </Label>
                    <div className="mt-2 space-y-2">
                      <div className="flex items-center space-x-2">
                        <input
                  ...
                  <div>
                    <Label className="text-base font-medium">
                      Do you agree to the{" "}
                      <Link to="/nda" className="text-accent hover:underline">
                        SentrIQ NDA
                      </Link>{" "}
                      and{" "}
                      <Link
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            placeholder="Share any additional information that would help us understand your background and interest in joining SentrIQ"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
