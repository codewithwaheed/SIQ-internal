        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16 animate-fade-in text-center">
            ...
            <p className="mx-auto max-w-3xl text-xl text-muted-foreground">
              Join our trusted network of cybersecurity professionals supporting SMBs with
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="mt-2 grid grid-cols-2 gap-2">
                      {['CISSP', 'CISM', 'CCSP', 'CISA', 'PMP', 'CEH'].map((cert) => (
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="mt-2 space-y-2">
                      {['One-time consultations', 'Recurring support', 'Both'].map((pref) => (
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    <Label className="text-base font-medium">
                      ...
                      and{' '}
                      <Link to="/code-of-conduct" className="text-accent hover:underline">
                        Code of Conduct
                      </Link>
                      ? *
                    </Label>
