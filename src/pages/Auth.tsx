...
import { Shield, Building, User, Lock, Users, HeadphonesIcon, Mail, CheckCircle, Eye, EyeOff, ArrowLeft, Zap, UserCheck, CreditCard, AlertTriangle } from 'lucide-react';
const Auth = () => {
  const {
    user,
    session,
  ...
  const handleSignUp = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (priceId && redirect === 'checkout') {
        redirectUrl = `${window.location.origin}/auth?priceId=${encodeURIComponent(priceId)}&redirect=checkout`;
      }
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <img src="/lovable-uploads/6362c9bd-c403-4a72-abae-4de6f5238518.png" alt="SentriQ Labs" className="h-12" />
          </div>
        ...
        <Card className="shadow-elevated border-0">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardDescription className="text-center">
              {showForgotPassword ? "Enter your email to reset your password" : "Sign in to your account or create a new one"}
            </CardDescription>
          </CardHeader>
          <CardContent>
            {showForgotPassword ? <div className="space-y-4">
                {resetEmailSent ? <Alert className="border-success bg-success/10">
                    <CheckCircle className="h-4 w-4 text-success" />
                    <AlertDescription className="text-success">
                      Password reset email sent! Check your inbox and follow the instructions.
                    </AlertDescription>
                  </Alert> : <form onSubmit={handleForgotPassword} className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="reset-email">Email Address</Label>
                      <Input id="reset-email" name="email" type="email" placeholder="Enter your email address" required className="h-11" />
                    </div>
                   ...
                   <form onSubmit={handleSignIn} className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Button type="button" variant="link" className="px-0 font-normal text-sm text-primary hover:text-primary/80" onClick={() => setShowForgotPassword(true)}>
                          Forgot password?
                        </Button>
                      </div>
                      <div className="relative">
                        <Input id="password" name="password" type={showPassword ? "text" : "password"} placeholder="Enter your password" required className="h-11 pr-10" />
                 ...
                 <TabsContent value="signup" className="mt-6">
                   <form onSubmit={handleSignUp} className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="signup-email" name="email" type="email" placeholder="Enter your email" required className="h-11" />
                    </div>
                     <div className="space-y-2">
