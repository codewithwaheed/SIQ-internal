          ...
          <Card className="animate-fade-in" style={{ animationDelay: '300ms' }}>
            ...
            <CardContent className="prose prose-gray max-w-none dark:prose-invert">
              <div className="space-y-6 leading-relaxed text-muted-foreground">
                <section>
                  <h3 className="mb-3 text-lg font-semibold text-foreground">1. Purpose</h3>
                  <p>
                    This Non-Disclosure Agreement ("Agreement") is entered into between SentrIQ
                    ("Company") and the consulting professional ("Consultant") to protect
                    confidential and proprietary information that may be disclosed during the course
                ...
                <section>
                  ...
                  <ul className="mt-2 list-disc space-y-1 pl-6">
                    ...
                    <li>
                      Use Confidential Information solely for the purpose of providing consulting
                      services
                    </li>
                    <li>
                      Not disclose Confidential Information to any third party without prior written
                      consent
                    </li>
                    <li>
                    ...
                    <li>
                      Return or destroy all Confidential Information upon termination of the
                      relationship
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <p>
                    Consultants acknowledge that client information is highly sensitive and must be
                    protected with the utmost care. This includes compliance frameworks, security
                    assessments, vulnerabilities, and business operations discussed during
                ...
                <section>
                  ...
                  <p>
                    This Agreement remains in effect for the duration of the consulting relationship
                    and continues indefinitely thereafter regarding the protection of Confidential
                    Information disclosed during the relationship.
                  </p>
                </section>

                <section>
                  <h3 className="mb-3 text-lg font-semibold text-foreground">7. Remedies</h3>
                  <p>
                    The Consultant acknowledges that any breach of this Agreement may cause
                    irreparable harm to SentrIQ and its clients, and that monetary damages may be
                    inadequate. Therefore, SentrIQ may seek injunctive relief and other equitable
                ...
                <section>
                  ...
                  <p>
                    ...
                    <a href="mailto:legal@sentriq.io" className="text-accent hover:underline">
                      legal@sentriq.io
                    </a>
                    .
                  </p>
                ...
                <div className="mt-8 rounded-lg bg-muted p-4">
                  <p className="text-sm">
                    ...
                    <br />
                    This document may be updated from time to time. Consultants will be notified of
