      ...
      <main className="pb-12 pt-24">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mb-12 text-center">
            ...
            <h1 className="mb-4 text-4xl font-bold tracking-tight">NIST 800-171 Compliance</h1>
          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-4">
              <p>
                NIST Special Publication 800-171 provides guidelines for protecting Controlled
                Unclassified Information (CUI) in nonfederal systems and organizations. It's
                essential for organizations that handle federal contract information or work with
                government agencies.
              </p>
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div>
                  <h4 className="mb-2 font-semibold">Industries Affected</h4>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-start gap-2">
          ...
          <Card>
            <CardContent className="p-8 text-center">
              <h3 className="mb-4 text-2xl font-bold">Need Help with NIST 800-171 Compliance?</h3>
              <p className="mb-6 text-muted-foreground">
                Our AI-powered platform can help you understand requirements, implement controls,
