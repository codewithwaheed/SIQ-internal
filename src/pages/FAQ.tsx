        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Get answers to common questions about SentrIQ and how it can help
                ...
                >
                  ...
                  <AccordionContent className="pb-6">
                    <p className="text-muted-foreground leading-relaxed">
                      {faq.question ===
                      "How do I become a SentrIQ consultant?" ? (
                        <>
                          We're building a trusted network of cybersecurity
                          professionals who want to support SMBs through
                          meaningful, flexible work. If you're experienced with
                          frameworks like NIST, CMMC, SOC 2, or FedRAMP and want
                          to provide on-demand guidance, you can apply to join
                          the SentrIQ consultant network by clicking{" "}
                          <Link
          ...
          {/* Contact Section */}
          <div
            className="bg-gradient-background rounded-lg p-8 text-center animate-fade-in"
