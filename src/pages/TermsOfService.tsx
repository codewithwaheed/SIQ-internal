      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="space-y-8">
          <div className="space-y-4 text-center">
            ...
            <p className="text-lg text-muted-foreground">Last updated: August 1, 2025</p>
          </div>
          ...
          <div className="prose prose-gray max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="space-y-4">
                <p>To access our services, you must create an account. You are responsible for:</p>
                <ul className="list-disc space-y-1 pl-6">
            ...
            <section>
              <h2 className="mb-4 text-2xl font-semibold">5. Payment and Billing</h2>
              <div className="space-y-4">
                <p>Subscription fees are billed in advance on a recurring basis. You agree to:</p>
                <ul className="list-disc space-y-1 pl-6">
                ...
                <p>We reserve the right to suspend or terminate services for non-payment.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <p>
                  SentrIQ retains all rights to our platform, technology, and proprietary
                  algorithms. You retain ownership of your data and content, while granting us
            ...
            <section>
              ...
              <div className="space-y-4">
                <p>
                  Our services are provided "as is" without warranties. While we strive for
                  accuracy, our AI recommendations should not replace professional security
                  assessment and legal advice. You are responsible for validating all compliance
                  recommendations.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <p>
                  SentrIQ's liability is limited to the amount paid for our services. We are not
            ...
            <section>
              ...
              <div className="space-y-4">
                <p>
                  ...
                  access to our services will cease, and we may delete your data according to our
                  retention policy.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <p>
                  ...
                  upon posting. Continued use of our services constitutes acceptance of revised
                  terms.
                </p>
              </div>
            </section>
