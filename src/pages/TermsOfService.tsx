          ...
          <div className="prose prose-gray max-w-none space-y-8">
            <section>
              ...
              <div className="space-y-4">
                <p>
                  By accessing and using SentrIQ's services, you accept and
                  agree to be bound by the terms and provision of this
                  agreement. If you do not agree to these terms, you may not use
                  our services.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <p>
                  SentrIQ provides AI-powered cybersecurity compliance
            ...
            <section>
              ...
              <div className="space-y-4">
                <p>
                  SentrIQ retains all rights to our platform, technology, and
                  proprietary algorithms. You retain ownership of your data and
                  content, while granting us necessary rights to provide our
                  services.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <p>
                  Our services are provided "as is" without warranties. While we
                  strive for accuracy, our AI recommendations should not replace
                  professional security assessment and legal advice. You are
                  responsible for validating all compliance recommendations.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <p>
                  SentrIQ's liability is limited to the amount paid for our
            ...
            <section>
              ...
              <div className="space-y-4">
                <p>
                  ...
                  termination, your access to our services will cease, and we
                  may delete your data according to our retention policy.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <p>
                  ...
                  Changes will be effective upon posting. Continued use of our
