        ...
        <Card>
          <CardContent className="p-6">
            <div className="text-center">
              ...
              <h3 className="mb-2 text-lg font-medium">Test Mode Disabled</h3>
              <p className="mb-4 text-muted-foreground">
                Enable test mode to run predefined scenarios and validate system behavior.
              </p>
              <Button onClick={() => setIsTestMode(true)}>Enable Test Mode</Button>
            </div>
          </CardContent>
        </Card>
      )}
                ...
                >
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      ...
                      {hasResult && <CheckCircle className="h-5 w-5 text-green-600" />}
                    </div>
                  </CardHeader>
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                    ...
                    <div className="text-center">
                      <div className="text-2xl font-bold text-blue-600">
                        {
                          Object.values(testResults).filter((r) => r.test_status === 'completed')
                            .length
                        }
                      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                  <h4 className="mb-2 font-medium">How to Use Test Mode</h4>
                ...
                <div>
                  <h4 className="mb-2 font-medium">Test Categories</h4>
                  <ul className="space-y-1 text-sm text-muted-foreground">
                    <li>
                      • <strong>Escalation:</strong> Tests when AI should escalate to humans
                    </li>
                    <li>
                      • <strong>AI Response:</strong> Tests AI knowledge and accuracy
                    </li>
                    <li>
                      • <strong>Security:</strong> Tests security guard and data protection
                    </li>
                    <li>
