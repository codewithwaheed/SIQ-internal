...
export const NotificationsInbox = () => {
      ...
      const mockNotifications: Notification[] = [
        {
          ...
          message: 'TechCorp Solutions has escalated a NIST 800-171 compliance issue marked as urgent priority.',
          read: false,
        ...
        },
        {
          ...
          message: 'SecureTech Inc is requesting an update on their CMMC Level 2 assessment progress.',
          read: false,
        ...
        },
        {
          ...
          priority: 'low',
          metadata: { rating: 5, feedback: 'Excellent guidance on policy implementation!' }
        },
        {
          id: '4',
          type: 'new_escalation',
  ...
  const getNotificationIcon = (type: string) => {
    switch (type) {
      case 'new_escalation': return <AlertTriangle className="h-4 w-4 text-warning" />;
      case 'follow_up': return <Clock className="h-4 w-4 text-accent" />;
      case 'feedback': return <Star className="h-4 w-4 text-success" />;
  ...
  const filteredNotifications = notifications.filter(notif => {
    ...
    if (filter === 'escalations') return notif.type === 'new_escalation' || notif.type === 'follow_up';
  ...
  return (
    <div className="page">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) => updateSettings({ email_new_escalations: checked })}
                          />
                        </div>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) => updateSettings({ email_follow_ups: checked })}
                          />
                        </div>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) => updateSettings({ slack_new_escalations: checked })}
                          />
                        </div>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) => updateSettings({ slack_follow_ups: checked })}
                          />
                        </div>
                      </div>
                    </div>
                     ...
                     <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) => updateSettings({ real_time_notifications: checked })}
                        />
                      </div>
      ...
      <div className="section-card">
        <h2 className="text-xl font-semibold mb-space-4">Recent Notifications</h2>
                ...
                {filteredNotifications.map((notification) => (
                  <div 
                    ...
                    className={`p-4 border rounded-lg transition-colors ${
                      !notification.read ? 'bg-accent/10 border-accent' : 'hover:bg-muted/50'
                    }`}
                  >
