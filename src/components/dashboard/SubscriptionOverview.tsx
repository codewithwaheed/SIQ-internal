...
export function SubscriptionOverview() {
  ...
  const { currentTier, getAllFeatureAccess, getUpgradeUrl, FEATURE_CONFIG } =
    useFeatureGating();
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  {usageData.uploads.limit !== -1 && (
                    <Progress
                      value={
                        (usageData.uploads.used / usageData.uploads.limit) * 100
                      }
                      className="h-2"
                    />
                  )}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-blue-700 dark:text-blue-200">
                      Upload documents, get expert help, and access advanced AI
                      capabilities.
                    </p>
