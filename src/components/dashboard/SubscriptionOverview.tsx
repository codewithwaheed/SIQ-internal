...
export function SubscriptionOverview() {
  ...
  const usageData = {
    uploads: { used: 2, limit: currentTier === 'Pro' ? 5 : currentTier === 'Premium' ? -1 : 0 },
    escalations: { used: 0, limit: currentTier === 'Pro' ? 1 : currentTier === 'Premium' ? 2 : 0 }
  };
    ...
    <div className="space-y-6">
        ...
        <CardHeader>
          ...
          <CardDescription>
            {subscriptionInfo?.subscription_end && (
              <span>
                Subscription active until {new Date(subscriptionInfo.subscription_end).toLocaleDateString()}
              </span>
            )}
          </CardDescription>
        </CardHeader>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium">
                      {usageData.uploads.used}/{usageData.uploads.limit === -1 ? '∞' : usageData.uploads.limit}
                    </span>
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium">
                      {usageData.escalations.used}/{usageData.escalations.limit === -1 ? '∞' : usageData.escalations.limit}
                    </span>
                  </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            See what features are available on your current plan
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <Button onClick={handleUpgrade} variant="outline">
                  View Pricing Plans <ArrowRight className="w-4 h-4 ml-1" />
                </Button>
              </div>
            </>
          )}
