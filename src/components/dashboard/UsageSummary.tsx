    ...
    <div className="page">
      ...
      <div className="grid-3">
        <div className="section-card-compact">
          ...
          <div className="space-y-2">
            <Progress value={(stats.chatsThisMonth / limits.chats) * 100} className="h-2" />
            <p className="text-xs text-muted-foreground">
              {stats.chatsThisMonth} of {limits.chats} used
              {isApproachingLimit(stats.chatsThisMonth, limits.chats) && (
                <span className="ml-1 text-amber-500">• Approaching limit</span>
              )}
            </p>
          </div>
        </div>
        ...
        <div className="section-card-compact">
          ...
          <div className="space-y-2">
            <Progress value={(stats.uploadsThisMonth / limits.uploads) * 100} className="h-2" />
            <p className="text-xs text-muted-foreground">
      ...
      {recentEscalations.length > 0 && (
        <div className="section-card">
          ...
          <p className="text-sm text-muted-foreground">Your latest expert consultation requests</p>
      ...
      {(isApproachingLimit(stats.chatsThisMonth, limits.chats) ||
        ...
        <div className="section-card-warning">
          ...
          <p className="text-sm text-amber-700">
            You're close to reaching your monthly limits. Consider upgrading your plan for more
            features.
          </p>
