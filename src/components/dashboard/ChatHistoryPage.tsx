            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-4">
                  {conversations.length === 0 ? "Start a conversation to see your chat history here" : "Try adjusting your search or filter criteria"}
                </p>
              ...
              filteredConversations.map(conv => (
                <div key={conv.id} className="section-card-compact group hover:bg-muted/50 transition-colors">
                  {editingConversation === conv.id ? (
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        <Button size="sm" onClick={saveTitle} disabled={updating || !editTitle.trim()} className="animate-fade-in">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0 cursor-pointer" onClick={() => navigate(`/dashboard?conversation=${conv.id}`)}>
