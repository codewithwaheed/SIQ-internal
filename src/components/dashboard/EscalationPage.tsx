...
import { AlertTriangle, Calendar, CheckCircle, FileText, MessageSquare, Send, Clock } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your request has been sent to our expert team. Expect a reply within 24-48 hours.",
      });
    } catch (error) {
        ...
        <Card className="border-green-200 bg-green-50/50">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-green-700 mb-6">
              Your escalation has been sent to our expert cybersecurity team. 
              A qualified consultant will review your case and follow up with you within 24-48 hours.
            </p>
          ...
          <div className="flex-gap-4 flex-col">
                ...
                <div className="flex items-center justify-between mb-space-4">
                  ...
                  <div className="flex items-center gap-space-2">
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, includeChat: e.target.checked }))}
                    />
                    <Label htmlFor="includeChat" className="text-sm">Include in request</Label>
                  </div>
                </div>
                <p className="text-muted-foreground mb-space-4">
                ...
                <div className="flex items-center justify-between mb-space-4">
                  ...
                  <div className="flex items-center gap-space-2">
                    <input
                      ...
                      onChange={(e) => setFormData(prev => ({ ...prev, includeDocuments: e.target.checked }))}
                    />
                    <Label htmlFor="includeDocuments" className="text-sm">Include in request</Label>
                  </div>
                </div>
                <p className="text-muted-foreground mb-space-4">
            ...
            <div className="section-card bg-blue-50/50 border-blue-200">
                ...
                <p className="text-sm text-blue-700">
                  ...
                  <strong> 24-48 hours</strong> during business days. For urgent security 
                  incidents, please mark as high priority.
              </p>
            </div>
          </div>
        </div>
