      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-32">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-3xl mx-auto">
            SentrIQ was developed by cybersecurity compliance professionals with
            decades of combined experience supporting U.S. military branches,
            federal agencies, and Fortune 500s across frameworks like NIST,
            CMMC, SOC 2, and HIPAA.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Button
              ...
              className="bg-accent hover:bg-accent/90 text-white text-lg px-8 py-4 h-auto"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Access certified cybersecurity consultants when you need that
                human touch
              </p>
            </div>
          </div>
