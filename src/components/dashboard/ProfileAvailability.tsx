              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setConsultantProfile(prev => ({ ...prev, first_name: e.target.value }))}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setConsultantProfile(prev => ({ ...prev, last_name: e.target.value }))}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setConsultantProfile(prev => ({ ...prev, email: e.target.value }))}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setConsultantProfile(prev => ({ ...prev, phone: e.target.value }))}
                    />
                  </div>
                  <div>
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => setConsultantProfile(prev => ({ ...prev, timezone: value }))}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setConsultantProfile(prev => ({ ...prev, hourly_rate: Number(e.target.value) }))}
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setConsultantProfile(prev => ({ ...prev, bio: e.target.value }))}
                    rows={4}
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex space-x-2">
                  <Select value={newSpecialization} onValueChange={setNewSpecialization}>
                    ...
                    <SelectContent>
                      {SPECIALIZATIONS.filter(s => !consultantProfile.specializations.includes(s)).map((spec) => (
                ...
                {['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'].map((day) => (
                  <div key={day} className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-2 flex-1">
                      <Input
                        type="time"
                        value={availability[`${day}_start` as keyof AvailabilitySettings] as string || ''}
                      ...
                      <Input
                        type="time"
                        value={availability[`${day}_end` as keyof AvailabilitySettings] as string || ''}
                        onChange={(e) => setAvailability(prev => ({ 
                          ...prev, 
