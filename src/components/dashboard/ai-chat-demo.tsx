        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Our AI assistant is trained on the latest cybersecurity frameworks
              and regulations. Ask questions in natural language and get
              expert-level guidance instantly.
            </p>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-success rounded-full"></div>
                <span className="text-foreground">
                  Trained on NIST 800-171, CMMC 2.0, FedRAMP
                </span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-success rounded-full"></div>
                <span className="text-foreground">
                  Updated regularly with latest guidance
                </span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-success rounded-full"></div>
                ...
                <div className="border-t border-border p-4">
                  <div className="flex space-x-2">
                    ...
                    <Button
                      ...
                      variant="ghost"
                      onClick={() =>
                        trackFeatureUsage("document_attachment_demo")
                      }
                    >
