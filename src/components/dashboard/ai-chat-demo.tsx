...
export const AiChatDemo = () => {
  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      const aiResponse = {
        type: "ai" as const,
        content: "This is a demo of our AI assistant. In the full version, I would provide detailed compliance guidance based on your specific question.",
        timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
      };
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Our AI assistant is trained on the latest cybersecurity frameworks and 
              regulations. Ask questions in natural language and get expert-level 
              guidance instantly.
            </p>
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-success rounded-full"></div>
                <span className="text-foreground">Contextual understanding of your environment</span>
              </div>
            </div>
          </div>
          <div>
