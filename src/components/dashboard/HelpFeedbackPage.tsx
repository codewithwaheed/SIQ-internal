    ...
    <div className="page">
      <div className="page-title">
        ...
        <p className="text-muted-foreground">
          You're part of our early access group, and your feedback plays a big role in making
          SentrIQ better. Whether it's a bug, a feature idea, or a small frustration, this is the
          place to share it.
        </p>
      </div>
      ...
      <div className="section-card">
        <form onSubmit={handleSubmit} className="flex-gap-4 flex-col">
          ...
          <div>
            ...
            <div className="rounded-lg border-2 border-dashed border-muted-foreground/25 p-space-6 text-center">
              <input
                type="file"
                id="screenshot"
                name="screenshot"
