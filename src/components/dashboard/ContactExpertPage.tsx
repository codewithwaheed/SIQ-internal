    ...
    <div className="page">
      <div className="page-title">
        ...
        <p className="text-muted-foreground">
          Connect with our certified cybersecurity professionals for advanced
      ...
      <div className="grid-2 lg:grid-cols-3">
        <div className="lg:col-span-2 section-card">
          <h2 className="text-xl font-semibold mb-space-2">
        ...
        <div className="flex-gap-4 flex-col">
          <div className="section-card">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  For immediate security threats, call our 24/7 hotline: +1
                  (555) 123-CYBER
                </p>
              </div>
            </div>
          ...
          <div className="section-card">
            <h3 className="text-lg font-semibold mb-space-4">
              What We Help With
            </h3>
