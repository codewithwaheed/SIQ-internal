...
const expertiseOptions = [
  'ISO 27001', 'NIST Cybersecurity Framework', 'SOC 2', 'HIPAA', 'GDPR',
  'PCI DSS', 'FedRAMP', 'CMMC', 'SOX', 'FISMA', 'COBIT',
  'Risk Assessment', 'Penetration Testing', 'Incident Response',
  'Cloud Security', 'Network Security', 'Application Security',
  'Identity & Access Management', 'Data Protection', 'Vulnerability Management'
];

export const ConsultantInviteModal = ({ open, onClose, onSuccess }: ConsultantInviteModalProps) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Select the cybersecurity frameworks and areas this consultant specializes in:
            </p>
          ...
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="message">Optional message to include in invitation</Label>
              <Textarea
                id="message"
