              ...
              <CardContent className="pt-4">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className={`text-2xl font-bold ${getScoreColor(run.aggregate_scores.json_validity_rate)}`}>
              ...
              <CardContent className="pt-4">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className={`text-2xl font-bold ${getScoreColor(run.aggregate_scores.escalation_accuracy)}`}>
                ...
                {run.individual_results.map((result, index) => (
                  ...
                  >
                    <div>
                      ...
                      {result.error && (
                        <span className="text-xs text-red-600 ml-2">Error: {result.error}</span>
                      )}
                    </div>
