    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Look up real-time vulnerability information from the National Vulnerability Database
            (NVD)
          </CardDescription>
        </CardHeader>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">{cveData.description}</p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              {/* CVSS Details */}
              <div>
                <h4 className="mb-2 font-medium">CVSS Scores</h4>
                <div className="space-y-1 text-sm">
                  {cveData.cvssV3 && (
                    <div>
            ...
            {cveData.cwe && cveData.cwe.length > 0 && (
              <div>
                <h4 className="mb-2 font-medium">Common Weakness Enumeration (CWE)</h4>
