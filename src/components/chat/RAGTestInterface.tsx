      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            This demonstrates how the system retrieves relevant knowledge and generates contextual
            responses.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            <label className="mb-2 block text-sm font-medium">Cybersecurity Question</label>
            <Textarea
              value={question}
          ...
          <div>
            <label className="mb-2 block text-sm font-medium">Sample Questions</label>
        ...
        <div className="space-y-4">
            ...
            <CardContent>
              ...
              <div className="mt-4 space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Badge
                    variant={response.ragMetrics.vectorSearchPerformed ? 'default' : 'secondary'}
                  >
                ...
                <div className="mt-3 text-sm font-medium">Security & Performance:</div>
                <div className="flex flex-wrap gap-2">
                  <Badge
                    variant={response.ragMetrics.securityFiltersApplied ? 'default' : 'secondary'}
                  >
                    Security Filters:{' '}
                    {response.ragMetrics.securityFiltersApplied ? 'Applied' : 'N/A'}
                  </Badge>
                  ...
                  <Badge
                    variant={response.ragMetrics.similarityThresholdMet ? 'default' : 'outline'}
                  >
                    Similarity Threshold:{' '}
                    {response.ragMetrics.similarityThresholdMet ? 'Met' : 'Below'}
                  </Badge>
              ...
              <CardContent>
                <div className="space-y-2">
                  {response.knowledgeContext.citations.map((citation, index) => (
                    <div key={index} className="flex items-center gap-3 rounded bg-muted p-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Model: {response.model} | Context Sources: {response.knowledgeContext.totalSources}
              </CardDescription>
            </CardHeader>
            <CardContent>
