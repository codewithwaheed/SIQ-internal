...
export const DocumentUploadSimple = ({ onUploadSuccess }: DocumentUploadSimpleProps) => {
  ...
  const handleUpload = async () => {
    ...
    if (!access.hasAccess) {
      toast({
        ...
        description: access.reason || 'Document upload is not available on your current plan.',
        variant: 'destructive',
      });
      return;
    }
  ...
  return (
    <div className="w-full space-y-4">
      ...
      <div
        className={`upload-zone ${isUploading ? 'uploading' : ''} hover-lift rounded-lg border-2 border-dashed border-muted-foreground/25 p-6 text-center transition-colors hover:border-muted-foreground/50`}
      >
        <input
          ref={fileInputRef}
          type="file"
          ...
          <div className="space-y-4">
            ...
            {isUploading && (
              <div className="space-y-2">
                ...
                <StatusIndicator
                  status={uploadStatus === 'uploading' ? 'loading' : uploadStatus}
                  message={
            ...
            <div className="space-y-3 text-left">
              ...
              <p className="text-xs text-muted-foreground">
                Tags help categorize documents for better AI retrieval. Max 5 tags.
              </p>
            </div>
            ...
            <RestrictedButton
              ...
              className={`button-press w-full ${uploadStatus === 'success' ? 'message-success' : ''}`}
            >
              {uploadStatus === 'success' ? (
                <>
