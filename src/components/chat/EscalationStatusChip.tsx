...
export const EscalationStatusChip = ({ escalation, className }: EscalationStatusChipProps) => {
  ...
  const minutesUntilSLA = timeUntilSLA ? Math.floor((timeUntilSLA % (1000 * 60 * 60)) / (1000 * 60)) : null;
    ...
    <Dialog open={detailsOpen} onOpenChange={setDetailsOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          {/* Current Status */}
          <div className={cn("p-3 rounded-lg border-l-4", statusConfig.bgColor)}>
              ...
              <div className="flex items-center gap-2">
                <div className="flex-1 bg-background rounded-full h-2">
                  <div 
                    ...
                    style={{ width: `${(escalation.routing_decision.final_score / 100) * 100}%` }}
                  />
                </div>
