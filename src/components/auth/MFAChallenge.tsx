  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!mfaChallenge?.factorId) {
        ...
        alert('MFA verification failed: No valid challenge found. Please try signing in again.');
        onBack();
        return;
      }
      ...
      if (error) {
        ...
        alert('Authentication code verification failed. Please check your code and try again.');
        return;
      }
      ...
      alert('MFA verification failed due to an unexpected error. Please try again.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <Card className="w-full max-w-md mx-auto">
      ...
      <CardContent className="space-y-4">
        <Alert>
          ...
          <AlertDescription>
            Open your authenticator app and enter the current 6-digit code for your account.
          </AlertDescription>
        </Alert>
