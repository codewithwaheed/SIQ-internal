...
export const SecurityEnhancementDashboard: React.FC = () => {
  ...
  const loadSecurityMetrics = async () => {
    try {
      ...
      const { data: suspiciousData, error: suspiciousError } = await supabase.rpc(
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Recent security-related activities</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Recent activities that may require attention</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Tools for maintaining system security</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-medium">Audit Log Cleanup</h4>
              <p className="text-sm text-muted-foreground">Remove audit logs older than 90 days</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Enhanced security features are active</p>
            </div>
