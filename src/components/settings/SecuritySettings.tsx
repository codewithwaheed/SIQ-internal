      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <Alert>
            ...
            <AlertDescription>
              <strong>Enable MFA:</strong> Multi-factor authentication adds an
          ...
          <Alert>
            ...
            <AlertDescription>
              <strong>Regular Password Updates:</strong> Consider updating your
              password every 3-6 months.
            </AlertDescription>
          </Alert>
          ...
          <Alert>
            ...
            <AlertDescription>
              <strong>Monitor Active Sessions:</strong> Regularly review and
