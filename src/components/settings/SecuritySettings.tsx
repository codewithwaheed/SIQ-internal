    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          {activeSessions.length === 0 ? (
            <p className="py-4 text-center text-muted-foreground">No active sessions found</p>
          ) : (
                ...
                >
                  <div className="flex-1">
                    <div className="flex items-center space-x-2">
                      <Badge variant="secondary">{session.ip_address || 'Unknown IP'}</Badge>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Review recent security-related events on your account</CardDescription>
        </CardHeader>
        <CardContent>
          {securityEvents.length === 0 ? (
            <p className="py-4 text-center text-muted-foreground">No recent security events</p>
          ) : (
            <div className="space-y-3">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <Alert>
            ...
            <AlertDescription>
              <strong>Enable MFA:</strong> Multi-factor authentication adds an extra layer of
          ...
          <Alert>
            ...
            <AlertDescription>
              <strong>Regular Password Updates:</strong> Consider updating your password every 3-6
              months.
            </AlertDescription>
          </Alert>
          ...
          <Alert>
            ...
            <AlertDescription>
              <strong>Monitor Active Sessions:</strong> Regularly review and terminate unrecognized
              sessions.
            </AlertDescription>
          </Alert>
        </CardContent>
