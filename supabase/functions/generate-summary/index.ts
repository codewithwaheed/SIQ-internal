...
serve(async (req) => {
  ...
  try {
    ...
    logStep("Request parsed", { conversationId, messageCount: messages.length });
...
Summary:`;
    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are a helpful assistant that creates concise, professional summaries of cybersecurity conversations.' },
