...
serve(async (req) => {
  ...
  try {
    ...
    const embeddingsTable = tableType === 'master_knowledge_base' 
    ...
    for (let i = 0; i < chunks.length; i++) {
      try {
        ...
        const embeddingRecord = tableType === 'master_knowledge_base' 
          ? {
    ...
    const updateTable = tableType === 'master_knowledge_base' ? 'master_knowledge_base' : 'documents';
