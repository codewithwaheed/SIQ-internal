...
serve(async (req) => {
  ...
  try {
    ...
    logStep("Request parsed", { question: question.substring(0, 100), documentIds, analysisType });
    ...
    if (!documents || documents.length === 0) {
      throw new Error("No documents found with extracted text. Please upload and process documents first.");
    }
